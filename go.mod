...
require (
	github.com/bborbe/collection v1.7.0 // indirect
	github.com/bborbe/math v1.1.0 // indirect
	github.com/bborbe/parse v1.4.2 // indirect
	github.com/bborbe/sentry v1.7.0 // indirect
	github.com/bborbe/time v1.8.2 // indirect
